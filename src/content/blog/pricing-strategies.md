...
## Table of Contents
- [Understanding Your Market](#understanding-your-market)
- [The Baseline: How to Set Your Starting Price](#the-baseline-how-to-set-your-starting-price)
- [Dynamic Pricing: The Core Strategy](#dynamic-pricing-the-core-strategy)
- [Seasonal and Event Pricing](#seasonal-and-event-pricing)
- [Strategic Discounts That Actually Work](#strategic-discounts-that-actually-work)
- [Dynamic Pricing Tools Compared](#dynamic-pricing-tools-compared)
...
Before you set a single price, you need to understand what the market will bear. Most hosts skip this step and either guess or copy a random competitor.
...
## The Baseline: How to Set Your Starting Price

Your baseline price is your default weekday rate outside of peak season. Everything else adjusts from here.

**For new listings:** Start 10-15% below comparable reviewed listings. The revenue you lose in the first few weeks is an investment in reviews, which unlock your ability to charge market rate later.
...
**Lead time:**
- Rates 90+ days out: slightly below market to lock in early bookings
- Rates 30-60 days out: market rate
- Rates 7-14 days out: if still unbooked, begin modest discounting
- Last 72 hours: aggressive last-minute pricing to avoid an empty calendar (an empty night earns $0)

**Booking window:**** 
Guests who book 6+ months in advance are typically less price-sensitive. Guests booking last-minute are often highly price-sensitive. Adjust accordingly.

---

## Seasonal and Event Pricing

Beyond day-of-week adjustments, your biggest revenue opportunities come from getting ahead of demand spikes.

**Seasonal peaks:**
- Summer (June-August) in most US markets
- Holidays: Thanksgiving, Christmas/New Year's, Memorial Day, Labor Day, 4th of July
- Spring break weeks (varies by region)

**Local events:**
This is where hosts leave the most money behind. A major conference, music festival, or sporting event can 2-3x your normal rate and still fill your calendar.
...
## Strategic Discounts That Actually Work

Discounts are tools, not defaults. Use them strategically:

**Weekly discount (10-20%):** Longer stays mean less turnover, less cleaning cost, and more predictable revenue. A 15% weekly discount often nets more per night after factoring in saved cleaning time and fees.

**Monthly discount (25-35%):** Medium-term stays (30+ nights) are increasingly valuable as digital nomadism grows. Monthly bookings also fall under different Airbnb policies that reduce your exposure on cancellations.

**Last-minute discount:** Set an automatic 10-15% discount for bookings made within 3 days of arrival. An occupied property at 85% of your target rate beats an empty one at 100%.

**New listing discount:** If you're launching, consider a 20% launch discount for your first 5-10 bookings. Reviews are worth more than the margin you sacrifice early on.

**Avoid:** Permanent discounts on your base price. If you need to discount permanently to fill your calendar, your base price is simply set too high.
...
Pricing strategy only improves if you measure results. Track these monthly:

| Metric | Target | What It Tells You |
|--------|--------|-------------------|
| Occupancy rate | 70-85% | Demand vs. supply balance |
| Average daily rate (ADR) | Market + 5-10% | Your pricing power |
| Revenue per available night (RevPAN) | Improving month-over-month | Overall performance |
| Booking lead time | Trending | Demand health |
